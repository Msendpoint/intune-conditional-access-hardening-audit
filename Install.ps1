<#
.SYNOPSIS
    One-click installer and launcher for Intune Hardening - Verify Conditional Access Policies via Microsoft Graph
...
Write-Host "    Intune Hardening - Verify Conditional Access Policies via Microsoft Graph" -ForegroundColor Cyan
...
$mainScript = Join-Path $scriptDir "scripts/intune-conditional-access-hardening-audit.ps1"
